...
const Home = () => {
  return (
    <div className="container mx-auto mt-[120px]">
      <div className="bg-[#ECF1F7] relative h-screen lg:max-h-[700px] rounded-[70px] flex flex-row justify-between overflow-hidden mb-[40px]">
        <div className=" px-2 py-2 lg:pl-32 lg:pt-32 absolute lg:relative z-10 px-auto container">
          ...
          <div className="mt-[120px] lg:relative flex justify-center lg:block">
            <Tabs />
          </div>
        </div>
        <div className="">
          <img
            className="size-[600px] absolute lg:relative bottom-10 right-0 lg:mt-[100px]"
            src={heroImg}
            alt=""
          />
        </div>
      ...
      <div className="container flex flex-col my-[100px]">
        <div className="w-full mx-auto lg:w-[600px] text-center">
          <h1 className="heading text-[44px] leading-[55px]">
            We are available in many well known countries
          </h1>
        </div>
        <div className=" max-w-full  mx-auto gap-10 mt-8 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
          <CountryCards />
        </div>
      </div>
