...
const Home = () => {
  return (
    <div className="container mx-auto mt-[120px] relative">
      <img
        className="size-[200px] lg:size-[600px] absolute top-0 right-0 bottom-0 left-0 z-[-1] lg:hidden"
        src={heroImg}
        alt=""
      />
      <div className="bg-[#ECF1F7] relative h-screen sm:h-[800px] lg:max-h-[600px] rounded-[70px] flex flex-col justify-between mb-[40px] overflow-hidden">
        <div className="px-2 py-2 lg:pt-32 absolute lg:relative z-10 container lg:w-2/3 ">
          <div className="w-full lg:max-w-[900px] text-center mx-auto">
            ...
            <p className="text__para mb-[10px] lg:mb-[40px]">
              The market place that matches Landlords with Property Managers
            </p>
          </div>
      ...
      <div className="container flex flex-col my-[100px]">
        ...
        <div className="flex justify-center">
          <div className="max-w-full pl-5 gap-20 mt-8 flex flex-row">
            <Benefits />
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#ECF1F7] container h-screen lg:max-h-[500px] rounded-[70px] flex flex-col md:flex-row justify-between overflow-hidden mb-[40px]">
        <div className="px-2 py-2 lg:pl-7 lg:pt-24 z-10 px-auto container w-full lg:max-w-[600px] mt-[60px] lg:mt-0 text-center lg:text-left lg:w-1/2">
          <div className="">
